...
- Name: smoke.spec.ts >> Master Frontend E2E Flows >> FLOW 2: Clients management
...
Call log:
  ...
  - waiting for locator('text=E2E Corp')
...
- main:
  ...
  - paragraph: Manage your clients and their associated projects.
  - button "Add Client"
  - textbox "Search clients..."
  - table:
    - rowgroup:
      - row "Name Industry Status Projects Actions":
        - columnheader "Name"
    ...
    - rowgroup:
      - row "Acme Corp acme.com Manufacturing ACTIVE 1 Open menu":
        - cell "Acme Corp acme.com":
          - link "Acme Corp":
            - /url: /clients/cli_1
          - text: acme.com
        - cell "Manufacturing"
        ...
        - cell "Open menu":
          - button "Open menu"
      - row "Globex globex.com Logistics ACTIVE 1 Open menu":
        - cell "Globex globex.com":
          - link "Globex":
            - /url: /clients/cli_2
          - text: globex.com
        - cell "Logistics"
        ...
        - cell "Open menu":
          - button "Open menu"
      - row "Initech initech.com Software INACTIVE 1 Open menu":
        - cell "Initech initech.com":
          - link "Initech":
            - /url: /clients/cli_3
          - text: initech.com
        - cell "Software"
