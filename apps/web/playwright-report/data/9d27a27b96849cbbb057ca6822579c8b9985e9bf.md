...
- Name: smoke.spec.ts >> Master Frontend E2E Flows >> FLOW 5: Team management
- Location: e2e\smoke.spec.ts:89:7
...
Locator: locator('text=E2E Member')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('text=E2E Member')
...
- main:
  ...
  - paragraph: Manage members, roles, and access controls.
  - button "Invite Member"
  - textbox "Search team members..."
  - table:
    - rowgroup:
      - row "Member Role Status Assigned Tasks Actions":
        - columnheader "Member"
        - columnheader "Role"
        - columnheader "Status"
        - columnheader "Assigned Tasks"
        - columnheader "Actions"
    - rowgroup:
      - row "A Alice Freeman You alice@northstar.co ADMIN online 2 Open menu":
        - cell "A Alice Freeman You alice@northstar.co"
        - cell "ADMIN"
        - cell "online"
        - cell "2"
        - cell "Open menu":
          - button "Open menu"
      - row "B Bob Smith bob@northstar.co MEMBER busy 1 Open menu":
        - cell "B Bob Smith bob@northstar.co"
        - cell "MEMBER"
        - cell "busy"
        - cell "1"
        - cell "Open menu":
